export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	elmetal: {
		...
		types: ["Electric", "Ground"],
		gender: "N",
		baseStats: {hp: 73, atk: 84, def: 89, spa: 115, spd: 85, spe: 76},
		abilities: {0: "Sheer Force"},
		heightm: 1.4,
		weightkg: 62,
		color: "Gray",
	...
	laestampida: {
		...
		types: ["Water", "Ground"],
		genderRatio: {M:0,F:1},
		baseStats: {hp: 103, atk: 103, def: 80, spa: 56, spd: 73, spe: 70},
		abilities: {0: "Huge Power"},
		heightm: 2.5,
		weightkg: 291,
		color: "Blue",
	...
	lavisita: {
		...
		types: ["Ghost", "Fire"],
		genderRatio: {M:0,F:1},
		baseStats: {hp: 68, atk: 61, def: 63, spa: 131, spd: 85, spe: 105},
		abilities: {0: "Prankster"},
		heightm: 1.6,
		weightkg: 46,
		color: "Purple",
